...
import mobile from '../../assets/Upper-mobile-image.png'; // Ensure the path is correct
...
const AppHeader = () => {
    ...
    return (
        <>
            <header className="bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 flex items-center justify-between px-[5%] py-4 relative">
